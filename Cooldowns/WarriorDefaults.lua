...
SetDefaults(Warrior.TALENT_TABS.ARMS, {
    "currentShout", "correctStance", "bladestorm", "sweepingStrikes", "tasteForBlood", "suddenDeath",
})
SetDefaults(Warrior.TALENT_TABS.FURY, {
    "currentShout", "correctStance", "deathWish", "recklessness", "bloodsurge",
})
SetDefaults(Warrior.TALENT_TABS.PROTECTION, {
    "currentShout", "correctStance", "shieldWall", "lastStand", "shieldBlock", "spellReflection",
    "enragedRegeneration", "vigilance", "shieldBash", "taunt", "shieldSlam", "shockwave", "swordAndBoard",
})
