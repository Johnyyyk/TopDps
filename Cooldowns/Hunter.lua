    ...
    addon.CooldownRegistry:Register({
        ...
        entries = {
            ...
            },
            {
                id = "rapidFire",
                type = "spell",
                spellIds = { Hunter.SPELL_IDS.rapidFire },
            ...
            },
            {
                id = "killCommand",
                type = "spell",
                spellIds = { Hunter.SPELL_IDS.killCommand },
                group = addon.COOLDOWN_GROUP_OFFENSIVE,
                order = 20,
            },
            {
                id = "deterrence",
                type = "spell",
                spellIds = { Hunter.SPELL_IDS.deterrence },
            ...
            },
            {
                id = "disengage",
                type = "spell",
                spellIds = { Hunter.SPELL_IDS.disengage },
            ...
            },
            {
                id = "feignDeath",
                type = "spell",
                spellIds = { Hunter.SPELL_IDS.feignDeath },
                group = addon.COOLDOWN_GROUP_UTILITY,
                order = 20,
            },
            {
                id = "misdirection",
                type = "spell",
                spellIds = { Hunter.SPELL_IDS.misdirection },
                group = addon.COOLDOWN_GROUP_UTILITY,
                order = 30,
            },
        },
    ...
    entries = {
        {
            id = "bestialWrath",
            type = "spell",
            spellIds = { Hunter.SPELL_IDS.bestialWrath },
            group = addon.COOLDOWN_GROUP_OFFENSIVE,
            order = 30,
        },
        {
            id = "beastWithin",
            type = "aura",
            auraSpellIds = { Hunter.SPELL_IDS.beastWithin },
            displaySpellId = Hunter.SPELL_IDS.beastWithin,
    ...
    entries = {
        {
            id = "readiness",
            type = "spell",
            spellIds = { Hunter.SPELL_IDS.readiness },
            group = addon.COOLDOWN_GROUP_OFFENSIVE,
            order = 30,
        },
        {
            id = "silencingShot",
            type = "spell",
            spellIds = { Hunter.SPELL_IDS.silencingShot },
            group = addon.COOLDOWN_GROUP_UTILITY,
            order = 40,
        },
    },
    ...
    entries = {
        {
            id = "lockAndLoad",
            type = "aura",
            auraSpellIds = { Hunter.SPELL_IDS.lockAndLoad },
            displaySpellId = Hunter.SPELL_IDS.lockAndLoad,
            showStacks = true,
            group = addon.COOLDOWN_GROUP_PROCS,
            order = 10,
        },
